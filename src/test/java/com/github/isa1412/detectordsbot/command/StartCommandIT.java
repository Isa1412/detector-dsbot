...
public class StartCommandIT {
    ...
    public void init() {
        ...
        Mockito.when(event.reply(responseService.getNewMemberResponse())).thenReturn(action);
        Mockito.when(event.reply(responseService.getAlreadyInResponse())).thenReturn(action);
        Mockito.when(event.reply(responseService.getInGameResponse())).thenReturn(action);
    }
    ...
    public void shouldProperlyNewMemberResponse() {
        ...
        //then
        Mockito.verify(event).reply(responseService.getNewMemberResponse());
    ...
    public void shouldProperlyAlreadyInResponse() {
        ...
        //then
        Mockito.verify(event).reply(responseService.getAlreadyInResponse());
        assertTrue(saved.isPresent());
        assertEquals(saved.get(), member);
    }
    ...
    public void shouldProperlyInGameResponse() {
        ...
        //then
        Mockito.verify(event).reply(responseService.getInGameResponse());
        assertTrue(saved.isPresent());
